...
export default function Call({ onSelect, navigation }) {
  ...
  const handlePress = () => {
    ...
    onSelect && onSelect(newValue ? "call" : null);
  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        <Text style={[styles.title, selected && styles.activeTitle]}>
          Call
        </Text>

        <Text style={[styles.subtitle, selected && styles.activeSubtitle]}>
