  ...
  const faqs = [
    {
      ...
      answer:
        "Numerology is the study of numbers related to your name, birth date, life path and personality.",
    },
    {
      id: "2",
      question: "What details are needed?",
      answer:
        "Your full name and date of birth are required for numerology reading.",
    },
    {
      id: "3",
      question: "Can numerology help in career?",
      answer:
        "Yes, numerology can guide you about suitable career, business direction, lucky dates and decision timing.",
    },
  ];
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        <View style={styles.bannerCard}>
          <Image
            source={{
              uri: "https://images.unsplash.com/photo-1518133835878-5a93cc3f89e5?w=1200&auto=format&fit=crop",
            }}
            style={styles.bannerImage}
          />

          <View style={styles.bannerOverlay}>
            <Text style={styles.bannerTitle}>Discover Your Lucky Numbers</Text>
            <Text style={styles.bannerSubtitle}>
              Understand your life path, destiny number and lucky timing
            </Text>
          </View>
        </View>
        ...
        <View style={styles.statsRow}>
          ...
          <View style={styles.statBox}>
            <Ionicons name="calculator" size={22} color="#1C9B5E" />
            <Text style={styles.statNumber}>Numbers</Text>
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.description}>
            Numerology helps you understand the hidden meaning behind your name,
            birth date, lucky numbers and life path. EvDivine experts provide
            guidance for career, business, relationship, marriage and personal
            growth using numerology calculations.
          </Text>
        </View>
        ...
        <View style={styles.card}>
          <Text style={styles.sectionTitle}>Why Choose Numerology?</Text>

          <View style={styles.whyItem}>
            <Ionicons name="sparkles-outline" size={24} color="#A34B1F" />
            <Text style={styles.whyText}>Know your lucky numbers and dates</Text>
          </View>

          <View style={styles.whyItem}>
            <Ionicons name="briefcase-outline" size={24} color="#A34B1F" />
            <Text style={styles.whyText}>Helpful for career and business decisions</Text>
          </View>

          <View style={styles.whyItem}>
            <Ionicons name="heart-circle-outline" size={24} color="#A34B1F" />
            <Text style={styles.whyText}>Understand relationship compatibility</Text>
          </View>
        </View>
      ...
      <View style={styles.bottomBar}>
        ...
        >
          ...
          <Text style={styles.bookButtonText}>Book Numerology</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
